...
@Service
public class RecommendAPIServicempl implements RecommendAPIService{

	@Override
	public String recommendAPI(String urlStr, String select, String value, String value2, String numOfRows, String apiType, String status_dt) {
		try {
    		// DB에 해당하는 API 호출
    		...
    		urlBuilder.append("&" + URLEncoder.encode("value","UTF-8") + "=" +URLEncoder.encode(value, "UTF-8"));
    		urlBuilder.append("&" + URLEncoder.encode("value2","UTF-8") + "=" +URLEncoder.encode(value2, "UTF-8")); //** 섹션이랑 연결해야함 **//
