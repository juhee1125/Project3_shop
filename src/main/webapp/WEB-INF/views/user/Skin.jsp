...
<body>
    <div class="wrap">
        <div class="container">
            <img src="/resources/img/스킨상단이미지.jpg" id="img1">
        </div>
        <div class="frame">
	        <c:forEach var="product" items="${skincategorylist}" varStatus="status">
	            <div class="product-set">
	                <div class="pathdiv">
	                    <img src="/admin/${skinpathlist[status.index]}" class="mainimg">
	                </div>
	                <div class="namediv">
